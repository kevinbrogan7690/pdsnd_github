...
# TO DO: get user input for city (chicago, new york city, washington). 
    while True:
      city = input("Which city would you like to filter by: Chicago, Washington, New York City").title()
 ...
 # TO DO: get user input for day of week 
    while True:
      day = input("Which day would you like to filter by: Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday or 'all'").title()
...
def time_stats(df):
    """Displays some statistics on the most frequent times of travel."""
...
def display_data(df):
    ...
    view_data = input("Would you like to view 10 rows of individual trip data? Please type yes or no?").lower()
    start_loc=0
    while(view_data=='yes'):       
